...
class VGGFace2Augmentation():
    def before_cut(self, frame, roi=None):
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, data, target_shape, with_augmentation=True, batch_size=64, custom_augmentation=None, num_classes=None, preprocessing='full_normalization'):
        if preprocessing not in ['full_normalization', 'z_normalization', 'vggface2', 'no']:
